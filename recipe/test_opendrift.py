...
print(o)
o.plot(fast=True, filename='test.png')
o.plot_oil_budget(filename='test.png')
#o.plot(filename='openoil_drift')
o.plot_vertical_distribution(maxnum=100,bins=50, filename='test.png')
o.plot_property('water_fraction', mean=True, filename='test.png')
o.plot_property('z', filename='test.png')
#o.plot_property('mass_evaporated')
#o.plot_property('water_fraction')
#o.plot_property('interfacial_area')
o.animation(fast=True, filename='test.mp4')
